...
<html lang="nb">
    <head>
        ...
        <meta property="og:url" content="http://localhost:8888/segmentchallenge/challenge/haukasen-trippelen" />
        <meta property="og:image" content="http://localhost:8888/segmentchallenge/segmentchallenge.png" />
        <meta property="og:description" content="3 knallharde segmenter opp til kula pÃ¥ toppen av HaukÃ¥sen" />
...
<script>document.body.style.backgroundImage = 'url(/segmentchallenge/images/IMAG0314.jpg)';</script>
    <!-- ****************************************************** -->
    <!-- ********************  INFOBOKSER ********************** -->
    <!-- ****************************************************** -->
<header>
    ...
    <div  style="margin: 10 0 0 20px;float:left;" class="fb-share-button" data-href="http://localhost:8888/segmentchallenge/challenge/haukasen-trippelen" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%3A8888%2Fsegmentchallenge%2Fchallenge%2Fhaukasen-trippelen&amp;src=sdkpreparse">Del</a></div>
...
<div class="card">
  <div class="card-block">
   <h6 class="card-header">
        <a  target="_blank" href="https://www.strava.com/segments/1282927">Hauken (Mariholtet Sportsstue - HaukÃ¥sen)</a>
...
<div class="card">
  <div class="card-block">
   <h6 class="card-header">
        <a  target="_blank" href="https://www.strava.com/segments/4917545">HaukÃ¥sen rett opp brutal</a>
        <p style="color:#666; font-size:12px;margin-top:5px;margin-bottom:0;">
    ...
    <script>var xhr = $.ajax({url: '/cache/haukasen-trippelen.json',success: function(response) {var d = new Date( xhr.getResponseHeader('Last-Modified') );var datetext=d.getHours()+':'+d.getMinutes();$('#tid').html('Sist oppdatert: ' + datetext);}});</script>        <table id="effort" class="display" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th rowspan="2">#</th>
                ...
                <tr>
                                       <th style="font-size:10px;font-weight:lighter;">Hauken (Mariholtet Sportsstue - HaukÃ¥sen)</th>
                                        <th style="font-size:10px;font-weight:lighter;">Lutdalen - Branntårn</th>
                                        <th style="font-size:10px;font-weight:lighter;">HaukÃ¥sen rett opp brutal</th>
